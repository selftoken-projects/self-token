...
const DelegatedTransferOperator = artifacts.require("DelegatedTransferOperatorWithIncreasingNonce");
...
contract('DelegatedTransferOperatorWithIncreasingNonce', function ([
  owner,
  alice,
  bob,
  charlie,
