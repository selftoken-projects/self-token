...
function shouldBehaveLikeOwnable(accounts) {
  describe('as an ownable', function () {
    ...
    it('should prevent non-owners from transfering', async function () {
      ...
      await shouldFail.reverting(this.ownable.transferOwnership(other, {
        from: other
      }));
    });
    ...
    it('should guard ownership against stuck state', async function () {
      ...
      await shouldFail.reverting(this.ownable.transferOwnership(null, {
        from: originalOwner
      }));
    });
    ...
    it('should prevent non-owners from renouncement', async function () {
      ...
      const owner = await this.ownable.owner.call();
      owner.should.not.eq(other);
      await shouldFail.reverting(this.ownable.renounceOwnership({
        from: other
      }));
    });
  });
